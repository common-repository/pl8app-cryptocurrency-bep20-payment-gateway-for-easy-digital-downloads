...
class pl8app_edd_Settings {
	...
	public function get_next_carousel_address($cryptoId) {
		$carousel = new pl8app_edd_Carousel($cryptoId);
	...
	public function get_hd_mode($cryptoId) {
		return apply_filters('pl8app_edd_hd_mode', '0', $cryptoId);
	}
	...
	public function add_consumed_tx($cryptoId, $address, $txHash) {
		$settingsKey = 'pl8app_edd_pro_' . $cryptoId . '_transactions_consumed_for_' . $address;
