...
// Crypto Helper
class pl8app_edd_Cryptocurrencies {

	public static function get() {
        // id, name, round_precision, icon_filename, refresh_time, symbol, has_hd, has_autopay, needs_confirmations, erc20contract
		$cryptoArray = array(
            'pl8app' => new pl8app_edd_Cryptocurrency('pl8app', 'pl8app', 7, pl8app_edd_PLUGIN_DIR . '/assets/img/pl8app_logo.png', 60, 'PL8APP', false, true, true, '0xb77178a0fdead814296eae631be8e8171c02592b'),
        );

        return apply_filters('pl8app_edd_bep20_custom_crypto', $cryptoArray);
	}
    ...
    public static function is_erc20_token($cryptoId) {
        ...
        if (array_key_exists($cryptoId, pl8app_edd_Cryptocurrencies::get_erc20_tokens())) {
            return true;
        }
    ...
    public static function get_erc20_contract($cryptoId) {
        $erc20Tokens = pl8app_edd_Cryptocurrencies::get_erc20_tokens();
	...
	public static function is_valid_wallet_address($cryptoId, $address) {
	    try{
            ...
            pl8app_edd_Util::log(__FILE__, __LINE__, 'Invalid cryptoId, contact plug-in developer.');
